 ...
 * @author mateu
 */
public class TeleFatorial extends javax.swing.JFrame {

    /**
     * Creates new form TeleFatorial
     */
    public TeleFatorial() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeleFatorial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeleFatorial().setVisible(true);
            }
        });
    }
